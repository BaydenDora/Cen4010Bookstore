...
{
	@Id
	private BigInteger myISBN; // ISBNs are 13-digit numbers
	...
	public book()
	{
		setISBN(BigInteger.valueOf(54645646));
		setTitle ("The Book");
	...
	// Constructor
	public book (BigInteger ISBN, String title, String description, int yearPublished, author author, publisher publisher, String genre, int copiesSold, int rating, double price)
	{
		setISBN (ISBN);
		setTitle (title);
	...
	// Setters
	protected void setISBN(BigInteger ISBN)
	{
		myISBN = ISBN;
